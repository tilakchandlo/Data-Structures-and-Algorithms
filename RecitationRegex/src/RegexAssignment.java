...
public class RegexAssignment{
    ...
    public static boolean testEmail(String email){
        return email.matches("([A-Za-z]+[A-Za-z0-9-._]+[@]+([A-Za-z]{1})+[A-Za-z0-9-._]+[.]+(com|net|org))");
    }
    ...
    public static boolean testName(String name){
        return name.matches("(([A-Z]{1})[A-Za-z-' ]*([A-Z]{1})[A-Za-z-' ]*)");
    }
    ...
    public static boolean testAddress(String address){
    	return address.matches("(\\d{1,5})\\s+([A-Za-z0-9 .-]*+\\n+([A-Z]{1})([A-Za-z0-9 .-]*)+(,?)+[ ]+([A-Z]{2})+[ ]+(\\d{5})+(-?)+(\\d{4})?)");
    }
    ...
    public static boolean testJavaExecutable(String java){
        return java.matches("(.|\\n)*public static void main"+"\\(String\\[\\] [A-Za-z\\$_]?[\\w\\$]*\\)(.|\\n)*");
    }
}