 ...
 */
    ...
    private AVL<Thing> t1() {
        Node<Thing> n0 = node(0);
        n0.setBalanceFactor(0);
        n0.setHeight(0);
        
        Node<Thing> n1 = node(1);
        n1.setBalanceFactor(-1);
        n1.setHeight(2);

        Node<Thing> n2 = node(2);
        n1.setBalanceFactor(-1);
        n1.setHeight(1);

        Node<Thing> n3 = node(3);
    ...
    private void preorder(Node<Thing> n, List<Thing> l) {
        if (n != null) {
            l.add(n.getData());
    ...
    private void inorder(Node<Thing> n, List<Thing> l) {
        if (n != null) {
            inorder(n.getLeft(), l);
            l.add(n.getData());
     ...
     */
    private Node<Thing> node(int i) {
        return new Node<AVLTests.Thing>(thing(i));
    }
